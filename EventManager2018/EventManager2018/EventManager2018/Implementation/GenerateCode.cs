...
namespace EventManager2018.Implementation
{
    public class GenerateCode
    {
        ...
        private static string CHARS_MINUSCULAS = "abcdefghijkmnopqrstuvwxyz";
        private static string CHARS_MAYUSCULAS = "ABCDEFGHJKLMNPQRSTUVWXYZ";
        private static string CHARS_NUMEROS = "1234567890";
        private static string CHARS_RAROS = "/";
        ...
        {
            CHARS_MINUSCULAS.ToCharArray(),
            CHARS_MAYUSCULAS.ToCharArray(),
            CHARS_NUMEROS.ToCharArray(),
            CHARS_RAROS.ToCharArray()
        };
            ...
            if (minLength < maxLength)
                code = new char[random.Next(minLength, maxLength + 1)];
            else
                code = new char[minLength];
            ...
            for (int i = 0; i < code.Length; i++)
            {
                ...
                code[i] = Chars_Grupos[nextGroupIdx][nextCharIdx];
